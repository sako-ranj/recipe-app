...
ThemeData darkTheme = ThemeData.dark().copyWith(appBarTheme: AppBarTheme(
      titleTextStyle: TextStyle(color: Colors.white, fontSize: 20,fontWeight: FontWeight.w400),iconTheme: IconThemeData(color: Colors.white)),
...
// button theme
  appBarTheme: AppBarTheme(
      ...
      titleTextStyle: TextStyle(color: Colors.black, fontSize: 20,fontWeight: FontWeight.w400),iconTheme: IconThemeData(color: Colors.black)),
  elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
          primary: Color(0xff002DE3), shape: StadiumBorder())),
  textButtonTheme: TextButtonThemeData(
